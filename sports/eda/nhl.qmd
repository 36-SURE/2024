...
This dataset contains all shot attempts from the 2023 NHL playoffs, courtesy of [MoneyPuck.com](http://moneypuck.com/data.htm).
...
```{r, eval = FALSE}
library(tidyverse)
nhl_shots <- read_csv("https://raw.githubusercontent.com/36-SURE/2024/main/data/nhl_shots.csv")
```

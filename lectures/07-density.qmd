...
Shot attempts by the [Sabrina Ionescu](https://en.wikipedia.org/wiki/Sabrina_Ionescu) in the 2023 WNBA season using [`wehoop`](https://wehoop.sportsdataverse.org/)
...
ionescu_shots <- read_csv("https://raw.githubusercontent.com/36-SURE/2024/main/data/ionescu_shots.csv")
...
```{r}
#| ref-label: shot-dist-hist-small
#| fig-height: 8
```
:::
...
ionescu_shots |>
  ...
  labs(x = "Shot distance (in feet)",
       y = "Number of Ionescu shot attempts")
```
:::

...
This dataset contains county-level hospitalization information on related to COVID-19 patient in Pennsylvania. with the dates ranging from April 1, 2020 to December 31, 2020.
...
```{r, eval=FALSE}
library(tidyverse)
covid_hospitalizations <- read_csv("https://raw.githubusercontent.com/36-SURE/2024/main/data/covid_hospitalizations.csv")
```